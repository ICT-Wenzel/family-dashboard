...
def weekly_schedule():
    ...
    <style>
        ...
        /* HARD FIX: Verstecke alle unsichtbaren Streamlit-Blöcke */
        ...
        /* HARD FIX: Leere Streamlit-Container (verhindert helle Boxen im Grid-Umfeld) */
    ...
    # Komponenten HTML für Grid (unverändert)
    st.components.v1.html(f"""
    <!DOCTYPE html>
    <html>
    <head>
